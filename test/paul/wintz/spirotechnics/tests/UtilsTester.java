...
import static paul.wintz.utils.Utils.doLengthsMatch;
...
public final class UtilsTester {
	...
	public void testDoLengthsMatch() {
		...
		assertTrue(doLengthsMatch(new boolean[3], new int[3], new String[3]));
		assertTrue(doLengthsMatch(new boolean[12], new int[12], new double[12], new double[12]));
		assertTrue(doLengthsMatch(new boolean[0], new Boolean[0]));

		assertFalse(doLengthsMatch(new boolean[0], new int[1]));
		assertFalse(doLengthsMatch(new boolean[3], new int[4], new Object[5]));

		try{
			doLengthsMatch(new Object());
			fail();
